...
namespace Ecomman.Controllers
{
    public class InventoriesController : Controller
    {
        ...
        public InventoriesController(ECommanDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Inventory != null ? 
                          ...
                          Problem("Entity set 'ECommanDbContext.Inventory'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ECommanDbContext.Inventory'  is null.");
            }
            var inventory = await _context.Inventory.FindAsync(id);
            if (inventory != null)
            {
